...
export const scrollbarRuler: Extension = ViewPlugin.fromClass(class {
...
export const scrollbarRulerTheme: Extension = EditorView.baseTheme({
  '.cm-scrollbar-gutter': {
    position: 'absolute',
    right: '0',
    width: '0.938rem',
...
export function scrollbarRulerExtension(): Extension {
  return [
    scrollbarRuler,
    scrollbarRulerTheme,
  ]
